...
var burgers = {
    // cat.all() - > make a database call to retrieve all cats
  all: function(cb) {
    // orm.all() - > make a database call to retrieve all cats
    // orm.all -> takes in 2 arguments, the table name and a callback function for when the data is returned
    orm.all("burgers", function(res) {
      console.log("ORM ALL", res)
      cb(res);
    });
  },
  ...
  // cat.delete is set to an anoymous function where we declare a condition and a cb
